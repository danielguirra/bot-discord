module.exports = {
    ...
    async execute(message) {
        ...
        const background = await Canvas.loadImage('https://i.im.ge/2021/09/24/TYiYOy.png')
        ...
        context.fillText(`@${member.displayName.replace(' ', '').replace(' ', '').toLowerCase()}oficial`, 280, 298);
        context.strokeText(`@${member.displayName.replace(' ', '').replace(' ', '').toLowerCase()}oficial`, 280, 298);
