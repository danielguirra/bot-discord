    ...
    message.reply({
      embeds: [
        ...
        Comandos para usar o Bot: 
          ...
          *moedas/Códigos das moedas mais usadas
          ...
          *duelo @fulano/Desafia o fulano para duelo
          ...
          *his @nomedochamp/Mostra a lore do champ
          *hab @nomedochamp/Mostra as skill's do champ
          *lero/Manda uma frase aletória
       `
        ),
      ],
    });
